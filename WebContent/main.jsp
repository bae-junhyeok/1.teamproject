...
<div id="headerWrap">
    ...
    %>		<li><a><%=session.getAttribute("sessionID") %>님 환영합니다</a></li>
			...
			<li><a href="bbs.jsp" accesskey="4" title="">이용후기</a></li>
		</ul>
	</div>
	</div>
	...
	<div class="clear"></div>
		...
		<div class="main">
		<div class="main-title" id="guest-room">객실 예약</div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(이미지를 클릭하세요)
			<ul>
				<li>
					<a href="room1.jsp"><img src="images/room1.jpg" width="450" height="300px"></a>
					<div class="info">
					<ul>
						<li><h3>스탠다드 (Standard)</h3></li>
						<li>객실크기: 8m<sup>2</sup></li>
						<li>침구: 더블베드 1개</li>
					</ul>
					</div>
				</li>
				<li><a href="room2.jsp"><img src="images/room2.jpg" width="450" height="300px"></a>
					<div class="info">
					<ul>
				...
				<li><a href="room3.jsp"><img src="images/room3.jpg" width="450" height="300px"></a>
					<div class="info">
					<ul>
						<li><h3>스위트 (Suite)</h3></li>
						<li>객실크기: 24m<sup>2</sup></li>
						<li>침구: 킹베드 1개
					</ul>
					</div>
				</li>
				<li><a href="room4.jsp"><img src="images/room4.jpg" width="450" height="300px"></a>
					<div class="info">
					<ul>
						<li><h3>풀 (Pool)</h3></li>
						<li>객실크기: 32m<sup>2</sup></li>
						<li>침구: 킹베드 1개</li>
					</ul>
					</div>
				</li>
		...
		<div class="using" id="use-info">
			<div class="header-padding">이용정보</div>
